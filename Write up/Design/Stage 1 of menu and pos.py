...
def starters():
    ...
    Button(screen9, text="Add to order", width=10, height=1).pack()
    Button (screen9 , text = "Fish").pack()
    Button (screen9 , text = "Chicken").pack()
    Button (screen9 , text = "Soup ").pack()
    Button (screen9 , text = "Salad").pack()
    Button (screen9 , text = "Fries").pack()
    Button (screen9 , text = "Prawns").pack()
...
def mainCourse():
    ...
    Button (screen10 , text = "Beef Stew").pack()
    Button (screen10 , text = "Cheese Dumplings ").pack()
    Button (screen10 , text = "Cottage Pie").pack()
    Button (screen10 , text = "Lasagne").pack()
    Button (screen10 , text = "Rice with Vegetable Curry").pack()
...
def drinks():
    ...
    Button (screen12 , text = "Coke").pack()
    Button (screen12 , text = "Dr Pepper").pack()
    Button (screen12 , text = "Fanta").pack()
    Button (screen12 , text = "Pepsi").pack()
    Button (screen12 , text = "Sprite").pack()
