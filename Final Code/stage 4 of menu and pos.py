...
##        self.txtCash.grid(row=1,column=1, sticky=W, padx=5)
        ...
        self.btnPay= Button(removeFrame, padx=2, font=('arial', 15, 'bold'), text="Pay", width=10, height=1, bd=2) #insert command=giveChange here once it works
