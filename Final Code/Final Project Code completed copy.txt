...
#############################################STAFF TIMETABLE ############################################################
        ...
        def analytics():
            ...
            ###########top ten items sold#################
            items = pd.read_csv('itemsSold.txt') # using pandas instead of csv Reader so that i can retrieve each column easily
                                                # and dont have to add for loop to add line numbers. 
